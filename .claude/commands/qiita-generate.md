...
ユーザーから OK または修正指示を受け取ったら、その内容を反映して Step 3 へ進む。
...
`config/topics.yaml` を topics.yaml モードで使った場合は、該当トピックの `status` を `generated` に Edit する。
